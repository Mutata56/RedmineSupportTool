// LEGACY / UNUSED
// Этот файл НЕ подключён в manifest.json и НЕ загружается расширением.
// Вся актуальная логика разнесена по:
//   - src/content/issues-menu.js  (SQL-кнопки, тулбар Redmine)
//   - src/old_extension/shared.js (copy-кнопки для SQL)
//   - src/old_extension/activity.js, sync.js
// Сохранён как референс на случай, если понадобится split-редактор
// или highlightStaleIssues - обе фичи отсюда нигде больше не реализованы.
// Перед использованием: вернуть в src/content/, добавить в manifest.json
// content_scripts (matches: <ссылка>) и устранить XSS на line 148
// (preview.innerHTML = html без санитизации ответа от Redmine).
